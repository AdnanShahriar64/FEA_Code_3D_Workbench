...
Seg2=(1/dt*MF-(1-Theta)*KF);
%
% F_Vel=Vel_Fx*ones(size(Vel_Fx,2),1)*0+Vel_Fy*ones(size(Vel_Fy,2),1)*0+Vel_Fz*ones(size(Vel_Fz,2),1)*10+Pr_F*100;
% F1=F_Vel.*FV_G;
% F2=F_Vel.*FV_G;
...
[C1Ue,C2Ue,C3Ue,C1Ve,C2Ve,C3Ve,C1We,C2We,C3We]=Elemental_Convective_Matrix_Generator_Diff(Element_Information,Mesh_Information_V,Material_Information,FE_Information_Region_Velocity,Velocity_x,Velocity_y,Velocity_z);
[C1U] = Assembly(C1Ue,Mesh_Information_V.Type,1,Mesh_Information_V.IEN,Mesh_Information_V.nel_Model,Mesh_Information_V.nnp_Model,Element_Information.nnp_Elemental);
[C2U] = Assembly(C2Ue,Mesh_Information_V.Type,1,Mesh_Information_V.IEN,Mesh_Information_V.nel_Model,Mesh_Information_V.nnp_Model,Element_Information.nnp_Elemental);
[C3U] = Assembly(C3Ue,Mesh_Information_V.Type,1,Mesh_Information_V.IEN,Mesh_Information_V.nel_Model,Mesh_Information_V.nnp_Model,Element_Information.nnp_Elemental);
[C1V] = Assembly(C1Ve,Mesh_Information_V.Type,1,Mesh_Information_V.IEN,Mesh_Information_V.nel_Model,Mesh_Information_V.nnp_Model,Element_Information.nnp_Elemental);
[C2V] = Assembly(C2Ve,Mesh_Information_V.Type,1,Mesh_Information_V.IEN,Mesh_Information_V.nel_Model,Mesh_Information_V.nnp_Model,Element_Information.nnp_Elemental);
[C3V] = Assembly(C3Ve,Mesh_Information_V.Type,1,Mesh_Information_V.IEN,Mesh_Information_V.nel_Model,Mesh_Information_V.nnp_Model,Element_Information.nnp_Elemental);
[C1W] = Assembly(C1We,Mesh_Information_V.Type,1,Mesh_Information_V.IEN,Mesh_Information_V.nel_Model,Mesh_Information_V.nnp_Model,Element_Information.nnp_Elemental);
[C2W] = Assembly(C2We,Mesh_Information_V.Type,1,Mesh_Information_V.IEN,Mesh_Information_V.nel_Model,Mesh_Information_V.nnp_Model,Element_Information.nnp_Elemental);
[C3W] = Assembly(C3We,Mesh_Information_V.Type,1,Mesh_Information_V.IEN,Mesh_Information_V.nel_Model,Mesh_Information_V.nnp_Model,Element_Information.nnp_Elemental);
                              
C1=K*0;
C1(1:length(Ci)*3,1:length(Ci)*3)=[C1U C2U C3U;
                                   C1V C2V C3V; 
                                   C1W C2W C3W];
...
for i=1:length(BC_Sets)
        ...
        if Node_No>0
            ...
            C(:,X_Node_No)=C(:,X_Node_No)*0;
            C(X_Node_No,X_Node_No)=1;  
...
for i=1:length(BC_Sets)
        ...
        if Node_No>0        
            ...
            C(:,Y_Node_No)=C(:,Y_Node_No)*0;
            C(Y_Node_No,Y_Node_No)=1;
...
for i=1:length(BC_Sets)
        ...
        if Node_No>0        
            ...
            C(:,Z_Node_No)=C(:,Z_Node_No)*0;
            C(Z_Node_No,Z_Node_No)=1;   
...
for i=1:length(Vel_Nodes)
        ...
        Vel_Fz=-K(:,Z_Node_No)-C(:,Z_Node_No);
        C(:,Z_Node_No)=C(:,Z_Node_No)*0;
        % KF(Z_Node_No,:)=KF(Z_Node_No,:)*0;
        C(Z_Node_No,Z_Node_No)=1;  
